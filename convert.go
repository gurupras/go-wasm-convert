...
func convertJSObjectToGoType(value js.Value) interface{} {
	if value.InstanceOf(js.Global().Get("Uint8Array")) {
		...
		return convertJSMapToGoMap(value)
	}
	return convertJSObjectToGoMap(value)
}
...
func convertJSObjectToGoMap(value js.Value) map[string]interface{} {
...
func convertJSMapToGoMap(jsMap js.Value) map[interface{}]interface{} {
...
func convertGoMapToJSObject(m map[string]interface{}) js.Value {
